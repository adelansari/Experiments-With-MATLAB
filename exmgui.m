...
%smh: slight modification for packaged app. 
       case 20, f = @xnothere; text(.1,.4,'      '), box on
      case 21, f = @xnothere; text(.1,.4,'      '), box off
      case 22, f = @xclose; text(.1,.4,'close'), box off
      case 23, f = @xnothere; text(.1,.4,'      '), box off
      case 24, f = @xnothere; text(.1,.4,'      '), box off
